...
import unittest
from info2soft.active.v20240228.Infomix import Infomix
...
class InfomixTestCase(unittest.TestCase):
    ...
    def testResumeInformixRule(self):
        ...
        infomix = Infomix(a)
        r = infomix.resumeInformixRule(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'Infomix', 'resumeInformixRule', body)
    ...
    def testrestartInformixRule(self):
        ...
        infomix = Infomix(a)
        r = infomix.restartInformixRule(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'Infomix', 'restartInformixRule', body)
    ...
    def teststopAnalysisInformixRule(self):
        ...
        infomix = Infomix(a)
        r = infomix.stopAnalysisInformixRule(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'Infomix', 'stopAnalysisInformixRule', body)
