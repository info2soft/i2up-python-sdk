...
import unittest
# from info2soft import Oceanbase
from info2soft.active.v20250123.Oceanbase import Oceanbase
...
class OceanbaseTestCase(unittest.TestCase):
    ...
    def testCreateBatchOceanRule(self):
        a = Auth(username, pwd)
        body = {
            'start_rule_now': 1,
            'rule_name': '12321',
        ...
        oceanbase = Oceanbase(a)
        r = oceanbase.createBatchOceanRule(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'Oceanbase', 'createBatchOceanRule', body)
    ...
    def testResetAnalysisOceanRule(self):
        a = Auth(username, pwd)
        body = {
            'operate': '',
            'rule_uuids': [],
        ...
        oceanbase = Oceanbase(a)
        r = oceanbase.resetAnalysisOceanRule(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'Oceanbase', 'resetAnalysisOceanRule', body)

    def testDuplicateOceanRule(self):
        a = Auth(username, pwd)
        body = {
            'operate': '',
            'rule_uuids': [],
        ...
        oceanbase = Oceanbase(a)
        r = oceanbase.duplicateOceanRule(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'Oceanbase', 'duplicateOceanRule', body)
    ...
    def testListSyncRulesStatus(self):
        ...
        oceanbase = Oceanbase(a)
        r = oceanbase.listSyncRulesStatus(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'Oceanbase', 'listSyncRulesStatus', body)

    def testCreateOceanTableFix(self):
        a = Auth(username, pwd)
        body = {
            'rule_uuid': '',
            'tab': '["I2.table"]',
        ...
        oceanbase = Oceanbase(a)
        r = oceanbase.createOceanTableFix(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'Oceanbase', 'createOceanTableFix', body)
