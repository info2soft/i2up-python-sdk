...
from info2soft.appContinuity.v20250630.AppContinuity import AppContinuity
...
class AppContinuityTestCase(unittest.TestCase):
    ...
    def testStartVmAppContinuity(self):
        a = Auth(username, pwd)
        body = {
            'rep_uuids': [],
            'operate': '',
        ...
        appContinuity = AppContinuity(a)
        r = appContinuity.startVmAppContinuity(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'AppContinuity', 'startVmAppContinuity', body)

    def testStopVmAppContinuity(self):
        a = Auth(username, pwd)
        body = {
            'rep_uuids': [],
            'operate': '',
        ...
        appContinuity = AppContinuity(a)
        r = appContinuity.stopVmAppContinuity(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'AppContinuity', 'stopVmAppContinuity', body)

    def testModifyVmAppContinuity(self):
        a = Auth(username, pwd)
        body = {
            'rep_uuids': [],
            'operate': '',
        ...
        appContinuity = AppContinuity(a)
        r = appContinuity.modifyVmAppContinuity(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'AppContinuity', 'modifyVmAppContinuity', body)
