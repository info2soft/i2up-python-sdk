...
from info2soft.dto.v20250630.Dto import Dto
...
class DtoTestCase(unittest.TestCase):
    ...
    def testListDtoRule(self):
        ...
        body = {
            ...
            'status': 'LIST_STOP',
            'where_args': {
            'rule_uuid': '5c292D1C-D3a4-24d7-8b3D-aCAff7A1e33A',
            'status': 'STOP',},
        }
    ...
    def testListDtoRuleSyncStatus(self):
        a = Auth(username, pwd)
        body = {
            'rule_uuid': '',
            'limit': 1,
        ...
        dto = Dto(a)
        r = dto.listDtoRuleSyncStatus(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'Dto', 'listDtoRuleSyncStatus', body)
    ...
    def testListDtoRuleSourcePath(self):
        a = Auth(username, pwd)
        body = {
            'host_uuid': '2bDd57fD-C5A9-Dc3D-3FB5-521b18fd473c',
            'timepoint': '@timestamp()',
            'host_ip': '',
            'prefix': '',
            'mapper_path': '',
