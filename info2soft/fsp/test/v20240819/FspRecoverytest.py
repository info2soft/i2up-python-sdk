...
import unittest
# from info2soft import FspRecovery
from info2soft.fsp.v20240819.FspRecovery import FspRecovery
...
class FspRecoveryTestCase(unittest.TestCase):
    ...
    def testModifyFspRecovery(self):
        ...
        fspRecovery = FspRecovery(a)
        r = fspRecovery.modifyFspRecovery(body, uuid)
        print(r[0])
        assert r[0]['ret'] == 200
    ...
    def testDesribeFspRecovery(self):
        ...
        fspRecovery = FspRecovery(a)
        r = fspRecovery.desribeFspRecovery(body, uuid)
        print(r[0])
        assert r[0]['ret'] == 200
    ...
    def testListFspRecoveryDriverListUrl(self):
        ...
        fspRecovery = FspRecovery(a)
        r = fspRecovery.listFspRecoveryDriverListUrl(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'FspRecovery', 'listFspRecoveryDriverListUrl', body)
    ...
    def testGetFspMoveBiosType(self):
        ...
        fspRecovery = FspRecovery(a)
        r = fspRecovery.getFspMoveBiosType(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'FspRecovery', 'getFspMoveBiosType', body)
