...
from info2soft.backupRule.v20250630.BackupRule import BackupRule
...
class BackupRuleTestCase(unittest.TestCase):
    ...
    def testDescribeScript(self):
        ...
        backupRule = BackupRule(a)
        r = backupRule.describeScript(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'BackupRule', 'describeScript', body)
    ...
    def testModifyScript(self):
        ...
        backupRule = BackupRule(a)
        r = backupRule.modifyScript(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'BackupRule', 'modifyScript', body)

    def testListDorisDb(self):
        a = Auth(username, pwd)
        body = {
            'node_uuid': '',
        }
        ...
        backupRule = BackupRule(a)
        r = backupRule.listDorisDb(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'BackupRule', 'listDorisDb', body)
