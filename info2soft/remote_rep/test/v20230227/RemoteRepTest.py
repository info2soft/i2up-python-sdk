...
import unittest
from info2soft.remote_rep.v20230227.RemoteRep import RemoteRep
# from info2soft.remoteRep.v20200722.RemoteRep import RemoteRep
...
class RemoteRepTestCase(unittest.TestCase):
    ...
    def testOperateRemoteRep(self):
        ...
        remoteRep = RemoteRep(a)
        r = remoteRep.operateRemoteRep(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'RemoteRep', 'operateRemoteRep', body)
