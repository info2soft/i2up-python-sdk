...
from info2soft.resource.v20240819.ActiveNodeV3 import ActiveNodeV3
...
class ActiveNodeV3TestCase(unittest.TestCase):
    ...
    def testListDbStatus(self):
        a = Auth(username, pwd)
        body = {
            'uuids': 'DfdF33a5-48Cb-de8A-8259-DF15E5fCE4ff',
        }
    ...
    def testCreateDbUnified(self):
        ...
        body = {
            'biz_grp_list': [],
            'db_name': 'Steven Jones',
            'node_uuid': 'b2D2cf76-C320-e24C-dEfd-0deB576CBC2F',
            'db_type': 'oracle',
            'file_open_type': '0',
            'deploy_mode': '0',
            'log_read_type': 'file',
            ...
            'auth': '',
            'replication_num': '',},
            'db_uuid': '7B2eF423-4d5E-e485-7c57-99e8296ce621',
            'db_mode': '',
            'cdb': '5A428eCa-bfdf-bFeB-7FdE-79B7139C692d',
            'maintenance': '',
            'password': '',
            'comment': '',
        }
    ...
    def testModifyDb(self):
        ...
        body = {
            ...
            'ip': '',
            'thread': '',},],},
            'cdb': 'A63B9Fd1-cc7E-1C22-2B4f-E7BEc237dC8A',
            'maintenance': '',
            'password': '',
        }
    ...
    def testActiveNode(self):
        ...
        body = {
            ...
            'cluster_switch': 1,
            'node_uuids': '',
            'password': '7e53912F-dF3C-28b3-C4cC-233FAb82E681',
            'node_type': '',
            'phy_type': 1,
            'log_dir': '/var/i2data/log/',
            'registered': 1,
            'maintenance': 0,
            'node_name': 'Brian Thomas',
            'comment': 'string',
            'web_uuid': 'a7dcbacC-b08D-236c-7FDB-DfFB4EfBeb81',
        }
    ...
    def testListNodeStatus(self):
        ...
        body = {
            'uuids': [
            'Aa8aB4e3-8De2-f2ec-fCCe-4A8E71fEB1d4',
            '50eb8C7b-30d6-C1Cc-3D4F-28dAcdCA3E1B',],
        }
    ...
    def testModifyNode(self):
        ...
        body = {
            ...
            'maintenance': 0,
            'comment': 'string',
            'web_uuid': '1F1D4Ecc-79BA-3eee-bd1A-CBC77A733e1C',
            'node_name': 'Kevin Johnson',
        }
    ...
    def testDeleteNode(self):
        ...
        body = {
            'force': 0,
            'uuids': [
            '7f8CcB7A-Beb9-9db2-91Df-C49e8EFF15C3',
            '28FDEdFc-C346-F139-e7Ac-648B615Bd48c',],
        }
    ...
    def testUpgradeNode(self):
        ...
        body = {
            'uuids': [
            'Ec295aD5-D0FC-7781-5f99-0dbCfe9aA1B3',],
        }
