...
from info2soft.resource.v20240819.Storage import Storage
...
class StorageTestCase(unittest.TestCase):
    ...
    def testListStorageStatus(self):
        ...
        body = {
            ...
            '9b62e838-8cb1-6b9D-Fbdd-4cbF2bCF65EE',],
            'force_refresh': 1,
        }
    ...
    def testListBkFile(self):
        a = Auth(username, pwd)
        body = {
            'tape_uuid': '5bFbBD6c-fFF0-d81A-2dE0-b4d748fFBd56',
            'library_sn': '38D9D6f7-948E-dBc4-BFb8-30ef48e215DE',
            'slot_index': '1',
            'slot_barcode': '8565512212627980	',
            'slot_tapename': '快或你系处	',
            'slot_tapesequence': '1942446089129832	',
            'bk_index': 'index',
            'bk_path': 'path',
            'page': 1,
            'limit': 10,
