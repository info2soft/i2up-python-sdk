...
from info2soft.resource.v20250630.Storage import Storage
...
class StorageTestCase(unittest.TestCase):
    ...
    def testListStorageStatus(self):
        ...
        body = {
            ...
            'f6817Ec9-6aF4-C4bC-ab74-56A08805DFA1',],
            'force_refresh': 1,
        }
    ...
    def testModifyStorageQuota(self):
        ...
        storage = Storage(a)
        r = storage.modifyStorageQuota(body, uuid)
        print(r[0])
        assert r[0]['ret'] == 200
    ...
    def testModifyStorageQuota(self):
        ...
        uuid1 = "22D03E06-94D0-5E2C-336E-4BEEC2D28EC4"
        uuid2 = "2C89B840-5E14-419B-B0CE-B8F53CFBCA11"

        storage = Storage(a)
        r = storage.modifyStorageQuota(body, uuid1, uuid2)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'Storage', 'modifyStorageQuota', body)
    ...
    def testListIscsiTargetList(self):
        a = Auth(username, pwd)
        body = {
            'bk_uuid': '',
        }
        ...
        storage = Storage(a)
        r = storage.listIscsiTargetList(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'Storage', 'listIscsiTargetList', body)
    ...
    def testCatalogTape(self):
        ...
        storage = Storage(a)
        r = storage.catalogTape(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'Storage', 'catalogTape', body)
    ...
    def testUpdatePoolsTape(self):
        ...
        storage = Storage(a)
        r = storage.updatePoolsTape(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'Storage', 'updatePoolsTape', body)
    ...
    def testListBkFile(self):
        a = Auth(username, pwd)
        body = {
            'tape_uuid': '39d62Ee6-1874-C9F2-01CA-57Fc12CF64a1',
            'library_sn': 'dA4eeBe2-4925-7c2A-bBbe-DDE583cd9eD5',
            'slot_index': '1',
            'slot_barcode': '1686772750505830	',
            'slot_tapename': '支如据次适	',
            'slot_tapesequence': '2402837539009534	',
            'bk_index': 'index',
            'bk_path': 'path',
            'page': 1,
            'limit': 10,
    ...
    def testDiscribeTapeDetail(self):
        a = Auth(username, pwd)
        body = {
            'library_sn': '',
            'slot_index': '',
        ...
        storage = Storage(a)
        r = storage.discribeTapeDetail(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'Storage', 'discribeTapeDetail', body)
    ...
    def testListTapePools(self):
        ...
        storage = Storage(a)
        r = storage.listTapePools(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'Storage', 'listTapePools', body)

    def testListTapePoolSlots(self):
        a = Auth(username, pwd)
        body = {
            'type': 1,
            'pool_uuid': '',
        ...
        storage = Storage(a)
        r = storage.listTapePoolSlots(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'Storage', 'listTapePoolSlots', body)
    ...
    def testCreateTapePool(self):
        ...
        storage = Storage(a)
        r = storage.createTapePool(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'Storage', 'createTapePool', body)

    def testAddSlotTapePool(self):
        a = Auth(username, pwd)
        body = {
            'pool_uuids': [],
            'operate': '',
        ...
        storage = Storage(a)
        r = storage.addSlotTapePool(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'Storage', 'addSlotTapePool', body)

    def testRemoveSlotTapePool(self):
        a = Auth(username, pwd)
        body = {
            'pool_uuids': [],
            'operate': '',
        ...
        storage = Storage(a)
        r = storage.removeSlotTapePool(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'Storage', 'removeSlotTapePool', body)
    ...
    def testDeleteTapePool(self):
        ...
        storage = Storage(a)
        r = storage.deleteTapePool(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'Storage', 'deleteTapePool', body)
    ...
    def testUpdateTapePool(self):
        ...
        storage = Storage(a)
        r = storage.updateTapePool(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'Storage', 'updateTapePool', body)

    def testListTapeNames(self):
        a = Auth(username, pwd)
        body = {
            'pool_uuid': '',
        }
        ...
        storage = Storage(a)
        r = storage.listTapeNames(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'Storage', 'listTapeNames', body)
