...
from info2soft.resource.v20250123.Storage import Storage
...
class StorageTestCase(unittest.TestCase):
    ...
    def testListStorageStatus(self):
        ...
        body = {
            ...
            '7D2c3D02-fAF5-b47E-774b-6c2cbB7e623A',],
            'force_refresh': 1,
        }
    ...
    def testListBkFile(self):
        a = Auth(username, pwd)
        body = {
            'tape_uuid': '5feFeCdf-32Cf-EA5c-feeA-b2adc0c7b3BB',
            'library_sn': 'DdA7A621-9DF8-b211-FC4D-51F4fEbC94eE',
            'slot_index': '1',
            'slot_barcode': '1321607070311984	',
            'slot_tapename': '条口义们及	',
            'slot_tapesequence': '3628666494597286	',
            'bk_index': 'index',
            'bk_path': 'path',
            'page': 1,
            'limit': 10,
