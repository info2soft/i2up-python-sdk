...
from info2soft.resource.v20250123.ContainerCluster import ContainerCluster
...
class ContainerClusterTestCase(unittest.TestCase):
    ...
    def testModifyCallbackSettings(self):
        ...
        body = {
            ...
            'cls_uuid': '',
            'pod': '',
            'uuid': 'b56FF76c-30E1-A826-E9Be-f0A4752B736f',
    ...
    def testCloneCallbackSettings(self):
        a = Auth(username, pwd)
        body = {
            'operate': '',
            'uuids': [],
        ...
        containerCluster = ContainerCluster(a)
        r = containerCluster.cloneCallbackSettings(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'ContainerCluster', 'cloneCallbackSettings', body)
