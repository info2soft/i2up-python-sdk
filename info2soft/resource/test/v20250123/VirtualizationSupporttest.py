...
from info2soft.resource.v20250123.VirtualizationSupport import VirtualizationSupport
...
class VirtualizationSupportTestCase(unittest.TestCase):
    ...
    def testListVmDiskByUuid(self):
        ...
        virtualizationSupport = VirtualizationSupport(a)
        r = virtualizationSupport.listVmDiskByUuid(body, uuid)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'VirtualizationSupport', 'listVmDiskByUuid', body)
