...
import unittest
from info2soft.resource.v20230227.StoragePool import StoragePool
...
class StoragePoolTestCase(unittest.TestCase):
    ...
    def testOperateStoragePool(self):
        a = Auth(username, pwd)
        body = {
            'pool_uuids': [],
            'operate': '',
        ...
        storagePool = StoragePool(a)
        r = storagePool.operateStoragePool(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'StoragePool', 'operateStoragePool', body)
