...
import unittest
from info2soft.resource.v20230227.Storage import Storage
# from info2soft.resource.v20200722.Storage import Storage
...
class StorageTestCase(unittest.TestCase):
    ...
    def testListStorageStatus(self):
        ...
        body = {
            'uuids': [
                ...
                'FffC9b2d-bBB0-F95A-02f1-9D2d6f4dCb4b', ],
            'force_refresh': 1,
        }
    ...
    def testHttps(self):
        ...
        storage = Storage(a)
        r = storage.https(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'Storage', 'https', body)
    ...
    def testListBkFile(self):
        a = Auth(username, pwd)
        body = {
            'tape_uuid': 'bfd1e818-B2Fd-2DF3-6a62-fc44BdCdC8B7',
            'library_sn': 'dDb1Fcd8-38Db-E8fC-bcfc-522F4AAE5Bbc',
            'slot _index': '1',
            'slot_barcode': '6512198699624064	',
            'slot_tapename': '一称员电影	',
            'slot_tapesequence': '4974789139388068	',
            'bk_index': 'index',
            'bk_path': 'path',
            'page': 1,
            'limit': 10,
    ...
    def testOperateTapePool(self):
        ...
        storage = Storage(a)
        r = storage.operateTapePool(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'Storage', 'operateTapePool', body)
