...
from info2soft.vpBackupRule.v20250630.VpBackupRule import VpBackupRule
...
class VpBackupRuleTestCase(unittest.TestCase):
    ...
    def testPreCheckVpBackupRule(self):
        a = Auth(username, pwd)
        body = {
        }
        ...
        vpBackupRule = VpBackupRule(a)
        r = vpBackupRule.preCheckVpBackupRule(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'VpBackupRule', 'preCheckVpBackupRule', body)
