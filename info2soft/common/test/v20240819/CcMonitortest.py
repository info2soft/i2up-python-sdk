...
import unittest
# from info2soft import CcMonitor
from info2soft.common.v20240819.CcMonitor import CcMonitor
...
class CcMonitorTestCase(unittest.TestCase):
    ...
    def testStartCcService(self):
        ...
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'CcMonitor', 'startCcService', body)
    ...
    def testReloadCcService(self):
        ...
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'CcMonitor', 'reloadCcService', body)
    ...
    def testStopCcService(self):
        ...
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'CcMonitor', 'stopCcService', body)
    ...
    def testKillCcProcess(self):
        ...
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'CcMonitor', 'killCcProcess', body)
