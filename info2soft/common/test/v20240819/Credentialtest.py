...
import unittest
# from info2soft import Credential
from info2soft.common.v20240819.Credential import Credential
...
class CredentialTestCase(unittest.TestCase):
    ...
    def testListBindUkey(self):
        ...
        credential = Credential(a)
        r = credential.listBindUkey(body)
        print(r[0])
        assert r[0]['ret'] == 200
        write(r[0], 'Credential', 'listBindUkey', body)
