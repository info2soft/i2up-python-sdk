...
class RepBackupTestCase(unittest.TestCase):
    ...
    def testDescribeRepBackup(self):
        a = Auth(username, pwd)
        repBackup = RepBackup(a)
        body = {"uuid": "F1479FED-B4DD-5063-AB92-6FA002C48198"}
    ...
    def testModifyRepBackup(self):
        a = Auth(username, pwd)
        repBackup = RepBackup(a)
        body = {"uuid": "62A2CCB5-A6B5-93D6-F373-4F6B26A98288","rep_backup":{"rep_uuid":"62A2CCB5-A6B5-93D6-F373-4F6B26A98288","rep_name":"d","ruleUnit":"","secret_key":"","bk_path_policy":"1","rep_mode":0,"cdp_path":"","wk_uuid":"DD32BA50-2053-FE24-915C-E70F416BFCF0","bk_uuid":"76AD38A0-16BF-5A8E-0A40-ADCCB4DA44E7","file_type_filter":"","policy_interval":"","mirr_file_check":"1","mirr_sync_flag":"1","mirr_open_type":"1","mirr_sync_attr":"1","encrypt_switch":"0","snapshot_switch":0,"cdp_snap_on":"0","cdp_snap_interval":30,"cdp_snap_count":240,"snapshot_interval":"24","snapshot_limit":"2","snapshot_policy":"0","snapshot_start":1545998028,"compress":"0","oph_policy":"0","oph_path":"","del_policy":"0","file_type_filter_switch":0,"wk_node_name":"26.11","bk_node_name":"26.12","cdp_switch":"0","cdp_detail_copy":3,"cdp_daily_copy":30,"cdp_process_time":"03:38:57","cdp_baseline_format":"0","cdp_bl_bkup_switch":0,"cdp_bl_sched_switch":0,"band_width":"","cdp_bl_sched":"","wk_path":["/1"],"bk_path":["/selinux/"],"excl_path":[],"bkup_one_time":None,"auto_start":"1","rep_type":0,"mirr_sched":"","mirr_sched_switch":0,"cmp_file_check":0,"cmp_schedule":[],"cmp_switch":0,"biz_grp_list":[],"mirr_skip":"0","thread_num":"0","id":"35","bkup_policy":"2","bkup_schedule":None,"create_time":"1545998014","random_str":"2DBDE99B-21BB-0F2D-FADA-B499DF224729","uuid":"62A2CCB5-A6B5-93D6-F373-4F6B26A98288","wk_ip":"192.168.26.11","wk_port":"26821","bk_ip":"192.168.26.12","bk_port":"26821","username":"admin","cdp_param":"3,30,0","disk_limit":"0","schedule":None,"user_uuid":"1BCFCAA3-E3C8-3E28-BDC5-BE36FDC2B5DC","group_uuid":None,"status":None,"sync_rep_uuid":None,"init_capacity":"0","bk_path_block":"0","ct_name_type":0,"ct_name_str1":"","ct_name_str2":"","ct_name_str3":None,"ct_name_str4":None,"is_from_ha":0,"biz_grp_name":[]}}
